...
/**
 * Precompiled lemur.published-library script plugin.
 **/
public class LemurPublishedLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_LemurPublishedLibrary").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("lemur.java-conventions");
            target.getPluginManager().apply("signing");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_LemurPublishedLibrary").asSubclass(BasicScript.class);
